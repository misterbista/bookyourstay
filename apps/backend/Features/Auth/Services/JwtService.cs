...
public sealed class JwtService
{
    ...
    public bool TryValidateAccessToken(string token, out (long UserId, Guid UserPublicId, Guid SessionPublicId) payload)
    {
        payload = default;
        ...
        try
        {
            ...
            payload = (userId, userPublicId, sessionPublicId);
            return true;
        }
        catch
        {
